...
__all__ = [
    'SP_VISEME_14', 'SpeechVoiceEvents', 'SPPS_Interjection',
    'DISPID_SGRClear', 'SRATopLevel', 'DISPID_SPEAudioTimeOffset',
    'SAFTTrueSpeech_8kHz1BitMono', 'SECNormalConfidence',
    'SpFileStream', 'SRERecoOtherContext', 'SpNullPhoneConverter',
    'DISPIDSPTSI_ActiveLength', 'SPSFunction',
    'SpeechVoiceCategoryTTSRate', 'ISpPhoneConverter',
    'DISPID_SRGetPropertyNumber', 'SVSFIsNotXML',
    'DISPID_SWFEBitsPerSample', 'SVSFUnusedFlags',
    'SpeechGrammarState', 'SPRECOSTATE', 'SPBOOKMARKOPTIONS',
    'DISPID_SBSSeek', 'SAFTText', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SMSSetData', 'SECFNoSpecialChars', 'SAFT8kHz8BitMono',
    'DISPID_SPIAudioSizeBytes', 'SRAImport', 'DISPID_SpeechVoice',
    'SDTAll', 'SAFT22kHz16BitMono', 'DISPID_SRGReset',
    'SVSFParseSapi', 'DISPID_SRRSetTextFeedback', 'DISPID_SRRTimes',
    'SPPS_RESERVED2', 'SGLexical', 'SDTLexicalForm', 'SWTDeleted',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SECFIgnoreKanaType',
    'ISequentialStream', 'DISPID_SOTGetAttribute',
    'DISPID_SGRSTsCount', 'SVSFIsFilename',
    'DISPID_SpeechLexiconProns', 'SpShortcut', 'SAFT16kHz16BitStereo',
    'ISpeechRecoResultTimes', 'SVSFNLPSpeakPunc', 'SAFT32kHz8BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTNonStandardFormat',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPEVENT',
    'eLEXTYPE_RESERVED9', 'ISpeechPhraseReplacement',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SLWType',
    'DISPID_SRCRequestedUIType', 'SAFT12kHz16BitStereo',
    'DISPID_SPIGetText', 'DISPID_SVEVoiceChange', 'DISPID_SVVolume',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRRTStreamTime',
    'SP_VISEME_19', 'ISpAudio', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_RESERVED6', 'SpeechAudioProperties',
    'DISPID_SRCEEndStream', 'DISPID_SPELexicalForm', 'ISpRecognizer2',
    'DISPID_SGRInitialState', 'SPPHRASE',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRuleParent',
    'SRCS_Enabled', 'DISPID_SPIGetDisplayAttributes',
    'SPSHT_NotOverriden', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRRPhraseInfo', 'DISPID_SDKGetlongValue',
    'SGDSActiveUserDelimited', 'DISPID_SRCERequestUI',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFTGSM610_8kHzMono',
    'DISPID_SVAlertBoundary', 'SPINTERFERENCE_TOOLOUD',
    'SPTEXTSELECTIONINFO', 'ISpeechLexiconPronunciations',
    'DISPID_SOTIsUISupported', 'SAFT44kHz16BitStereo',
    'DISPID_SRGSetTextSelection', 'ISpeechAudioStatus',
    'ISpeechPhraseElement', 'SVSFParseAutodetect',
    'DISPID_SRSNumberOfActiveRules', 'SPAO_NONE',
    'DISPID_SRIsUISupported', 'DISPID_SVSInputWordPosition',
    'SPSHT_OTHER', 'SAFTADPCM_44kHzStereo', 'SpeechRunState',
    'SPAUDIOSTATUS', 'DISPID_SOTCId', 'SPSERIALIZEDRESULT',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SLWsItem',
    'SpeechAudioFormatType', 'SPGRAMMARWORDTYPE',
    'SGDSActiveWithAutoPause', 'SP_VISEME_18', 'SPPS_RESERVED4',
    'DISPID_SDKOpenKey', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRGCmdSetRuleIdState', 'SPRS_ACTIVE',
    'DISPID_SpeechAudio', 'DISPID_SpeechCustomStream', 'STCAll',
    'eLEXTYPE_PRIVATE2', 'SpeechRecoContextState', 'SPWORD',
    'DISPID_SRGRules', 'SLTApp', 'SP_VISEME_21',
    'DISPID_SpeechFileStream', 'ISpRecoResult', 'DISPID_SVEPhoneme',
    'SP_VISEME_1', 'DISPID_SRCRetainedAudioFormat',
    'SGRSTTTextBuffer', 'SP_VISEME_16', 'SPPHRASEREPLACEMENT',
    'SPVPRI_ALERT', 'DISPID_SRGCommit', 'SpeechAudioState',
    'SECHighConfidence', 'SAFT11kHz8BitStereo', 'SPSLMA', 'SPPS_Verb',
    'SLTUser', 'DISPID_SLWWord', 'DISPID_SPEEngineConfidence',
    'DISPID_SpeechGrammarRule', 'ISpeechPhraseReplacements',
    'SpeechPropertyResponseSpeed', 'SPSERIALIZEDPHRASE',
    'SRSActiveAlways', 'DISPID_SFSOpen', 'SREStreamStart',
    'SPRECORESULTTIMES', 'SPPARTOFSPEECH', 'SDKLDefaultLocation',
    'DISPID_SPRuleId', 'ISpeechMemoryStream', 'SRESoundStart',
    'DISPID_SPEActualConfidence',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechGrammarWordType', 'SVSFPersistXML', 'SECLowConfidence',
    'SPEI_END_SR_STREAM', 'DISPID_SVSInputSentenceLength',
    'SVEViseme', 'DISPID_SGRsCommit', 'eLEXTYPE_PRIVATE5',
    'SpeechCategoryAppLexicons', 'SSTTTextBuffer', 'SASRun',
    'DISPID_SWFEBlockAlign', 'SDTAlternates', 'eLEXTYPE_PRIVATE12',
    'SPEI_RECOGNITION', 'SPEVENTENUM', 'SpVoice',
    'DISPID_SPIEnginePrivateData', 'DISPID_SVAudioOutputStream',
    'eLEXTYPE_RESERVED10', 'SGSEnabled', 'DISPID_SGRSTType',
    'Speech_StreamPos_RealTime', 'SpPhoneConverter', 'ISpDataKey',
    'SVEBookmark', 'DISPID_SPEAudioSizeTime', 'SFTInput',
    'DISPID_SGRsFindRule', 'DISPID_SpeechObjectTokenCategory',
    'ISpeechLexiconWords', 'DISPID_SWFEChannels', 'DISPID_SPIRule',
    'DISPID_SVStatus', 'SPAUDIOBUFFERINFO',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPEDisplayText',
    'SPWT_LEXICAL', 'SAFTADPCM_22kHzMono', 'SP_VISEME_0',
    'DISPID_SPPChildren', 'SP_VISEME_15',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SDKLLocalMachine', 'DISPID_SPRs_NewEnum', 'SVSFPurgeBeforeSpeak',
    'ISpeechBaseStream', 'SPAS_RUN', 'DISPID_SASFreeBufferSpace',
    'SPEI_MAX_SR', 'ISpeechCustomStream',
    'SpeechStreamSeekPositionType', 'ISpeechObjectToken',
    'SRTEmulated', 'ISpeechMMSysAudio', 'DISPID_SRStatus',
    'DISPID_SGRSTsItem', 'ISpLexicon', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRCERecognition', 'DISPID_SRRAudio',
    'ISpPhoneticAlphabetConverter', 'SWTAdded', 'SAFT48kHz16BitMono',
    'SPSMF_UPS', 'SDTProperty', 'DISPID_SPPConfidence',
    'DISPID_SVEStreamEnd', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_PRIVATE18', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRCEEnginePrivate', 'SPAR_High', 'DISPID_SVSLastResult',
    'DISPID_SPPValue', 'STSF_CommonAppData', 'DISPID_SRGetFormat',
    'DISPID_SRCEAudioLevel', 'DISPID_SVSLastBookmarkId',
    'SAFTADPCM_11kHzStereo', 'ISpeechXMLRecoResult',
    'SpInProcRecoContext', 'UINT_PTR', 'DISPID_SRRGetXMLResult',
    'DISPID_SpeechGrammarRuleStateTransition', 'SAFT48kHz16BitStereo',
    'SpSharedRecognizer', 'SASClosed', 'SPPS_Function',
    'DISPID_SpeechAudioStatus', 'DISPID_SpeechPhraseRules',
    'DISPID_SDKEnumValues', 'SAFTADPCM_44kHzMono',
    'SREPropertyStringChange', 'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechPhraseElements', 'DISPID_SPEAudioStreamOffset',
    'SPEI_SR_PRIVATE', 'ISpeechLexicon', 'SpeechCategoryVoices',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPARecoResult',
    'SDA_One_Trailing_Space', 'SVEWordBoundary', 'STCRemoteServer',
    'DISPID_SGRSTransitions', 'ISpRecognizer3',
    'DISPID_SLGetPronunciations', 'SpeechRecognitionType',
    'SPGS_EXCLUSIVE', 'DISPID_SASState', 'SVP_4',
    'ISpeechPhoneConverter', 'DISPID_SpeechBaseStream',
    'DISPID_SVEWord', 'DISPID_SpeechLexiconWord', 'SVP_21',
    'SpeechPropertyAdaptationOn', 'ISpeechVoiceStatus', 'ISpVoice',
    'DISPID_SGRId', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SRSInactive', 'SPCT_SUB_DICTATION', 'SPAR_Unknown',
    'DISPID_SOTs_NewEnum', 'DISPID_SPPFirstElement', 'SRAExport',
    'SVP_5', 'SpeechVisemeType', 'DISPID_SGRSTRule', 'DISPID_SVSkip',
    'SPVPRI_OVER', 'DISPID_SGRSTs_NewEnum', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPILanguageId', 'DISPID_SRSAudioStatus',
    'SAFT24kHz16BitMono', 'DISPID_SpeechPhraseAlternates',
    'SPEI_RECO_OTHER_CONTEXT', 'SGPronounciation', 'SP_VISEME_20',
    'DISPID_SpeechObjectToken', 'ISpeechLexiconPronunciation',
    'DISPID_SpeechMemoryStream', 'SPXRO_Alternates_SML',
    'SP_VISEME_10', 'DISPID_SVEViseme', 'eWORDTYPE_ADDED',
    'SPLO_DYNAMIC', 'ISpRecoGrammar', 'DISPID_SVSpeak',
    'SAFTADPCM_8kHzMono', 'DISPID_SRCVoicePurgeEvent',
    'SPPS_RESERVED1', 'SVP_3', 'SECFIgnoreWidth',
    'DISPID_SOTDisplayUI', 'SP_VISEME_2', 'eLEXTYPE_PRIVATE19',
    'SAFT44kHz8BitMono', 'SPAS_PAUSE', 'ISpeechPhraseProperties',
    'SAFT24kHz16BitStereo', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SLGenerationId', 'SPWT_PRONUNCIATION',
    'DISPID_SVDisplayUI', 'SVP_15', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechAudioFormatGUIDText', 'DISPID_SLPsItem',
    'DISPID_SMSGetData', 'DISPID_SLAddPronunciation',
    'STCInprocHandler', 'DISPID_SLPs_NewEnum',
    'DISPID_SRRGetXMLErrorInfo', 'SDKLCurrentConfig',
    'SPPS_NotOverriden', 'Speech_Max_Word_Length', 'SITooLoud',
    'SpStream', 'SPEI_ADAPTATION', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SABufferNotifySize', 'DISPID_SpeechRecoResult2',
    'DISPID_SAFGuid', 'SWPUnknownWordUnpronounceable', 'SITooFast',
    'DISPID_SGRAttributes', 'SPPS_Unknown', 'SpeechVoiceSpeakFlags',
    'DISPID_SRProfile', 'ISpeechAudioBufferInfo',
    'SSSPTRelativeToCurrentPosition', 'SPSVerb',
    'SPWORDPRONUNCIATION', 'SAFT32kHz8BitStereo', 'eWORDTYPE_DELETED',
    'DISPID_SRCERecognizerStateChange', 'SP_VISEME_12',
    'ISpeechWaveFormatEx', 'SPINTERFERENCE_NONE',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SpeechRecognizerStatus',
    'SPSInterjection', 'SpeechStreamFileMode', 'ISpeechAudioFormat',
    'DISPID_SOTCGetDataKey', 'DISPID_SPPId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPBINARYGRAMMAR', 'SPSHT_EMAIL', 'DISPID_SBSFormat',
    'SECFIgnoreCase', 'SREPrivate', 'SVP_0',
    'ISpeechGrammarRuleState', 'SLODynamic',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SBSRead',
    'ISpSerializeState', 'SPAS_STOP', 'DISPID_SRCEHypothesis',
    'SPEI_RESERVED1', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SpeechVoiceEvent', 'SRARoot',
    'DISPID_SPRuleNumberOfElements', 'ISpeechResourceLoader',
    'DISPID_SRSetPropertyNumber', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SpeechPhraseElement', 'DISPID_SPPsItem',
    'DISPID_SOTDataKey', 'SpeechMicTraining', 'SVSFParseSsml',
    'SpSharedRecoContext', 'SRADefaultToActive', 'SPRULESTATE',
    'ISpeechLexiconWord', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPBO_TIME_UNITS', 'DISPID_SPRulesCount', 'DISPID_SOTCDefault',
    'SPPS_Modifier', 'DISPID_SRRTOffsetFromStart',
    'SpeechGrammarTagDictation', 'Speech_StreamPos_Asap',
    'SVSFlagsAsync', 'tagSPTEXTSELECTIONINFO', 'SPCT_SLEEP',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SREmulateRecognition',
    'ISpStreamFormat', 'eLEXTYPE_RESERVED8', 'DISPID_SRGId',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVIsUISupported', 'eLEXTYPE_PRIVATE6', 'DISPID_SPRsCount',
    'DISPID_SRCCmdMaxAlternates', 'SPBO_PAUSE',
    'DISPID_SRCreateRecoContext', '_RemotableHandle',
    'DISPID_SPPName', 'SRESoundEnd', 'DISPID_SVSPhonemeId',
    'SPFM_CREATE', 'eLEXTYPE_PRIVATE20', 'SRSInactiveWithPurge',
    'DISPID_SVGetAudioInputs', 'ISpRecoCategory',
    'ISpeechRecognizerStatus', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_SuppressWord',
    'SRSEIsSpeaking', 'SGLexicalNoSpecialChars', 'SVP_1',
    'SP_VISEME_3', 'DISPID_SVSyncronousSpeakTimeout',
    'SPPHRASEELEMENT', 'DISPID_SWFESamplesPerSec',
    'eLEXTYPE_RESERVED7', 'DISPID_SPERequiredConfidence',
    'DISPID_SRRRecoContext', 'ISpEventSource', 'SpeechAudioVolume',
    'DISPID_SRCESoundStart', 'SAFT44kHz8BitStereo',
    'DISPID_SLWPronunciations', 'SITooQuiet', 'SpeechPartOfSpeech',
    'DISPID_SABIEventBias', 'SpeechInterference',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpeechDictationTopicSpelling',
    'SpUnCompressedLexicon', 'SpeechCategoryPhoneConverters',
    'SREAdaptation', 'SAFT48kHz8BitMono', 'SRERequestUI',
    'DISPID_SRAudioInput', 'DISPID_SGRSAddRuleTransition', 'SVP_16',
    'ISpeechPhraseProperty', 'IInternetSecurityManager',
    'SpeechGrammarTagWildcard', 'SPWF_SRENGINE', 'SPSNotOverriden',
    'SGRSTTEpsilon', 'SAFT44kHz16BitMono', 'SPAR_Low',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechGrammarRuleState',
    'SPINTERFERENCE_TOOQUIET', 'SSFMCreate',
    'DISPID_SpeechRecognizer', 'DISPID_SVEEnginePrivate',
    'SPXMLRESULTOPTIONS', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRRSpeakAudio', 'SDA_Consume_Leading_Spaces',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechPhraseProperties', 'Speech_Default_Weight',
    'DISPID_SPRules_NewEnum', 'SpeechVisemeFeature',
    'DISPID_SRGetPropertyString', 'SDA_No_Trailing_Space',
    'DISPIDSPTSI_SelectionLength', 'SVP_18', 'SPDKL_CurrentUser',
    'DISPID_SRCBookmark', 'SPEI_SR_BOOKMARK',
    'DISPID_SVSRunningState', 'SRAONone', 'SPRST_NUM_STATES',
    'DISPID_SVVoice', 'ISpeechPhraseInfo', 'SPEI_RESERVED2',
    'STSF_FlagCreate', '_ISpeechRecoContextEvents',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SpeechGrammarRules', 'SpeechWordPronounceable',
    'DISPID_SAVolume', 'DISPID_SPISaveToMemory',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechPhoneConverter',
    'SAFT22kHz8BitMono', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechAudioFormat', 'SSFMOpenReadWrite',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SMSADeviceId',
    'DISPID_SRCVoice', 'SPXRO_SML', 'SpeechBookmarkOptions',
    'DISPID_SPACommit', 'DISPID_SGRSTPropertyValue',
    'ISpNotifySource', 'SGRSTTDictation',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRCRecognizer',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPRDisplayAttributes',
    'SREAllEvents', 'SPCATEGORYTYPE', 'SVSFIsXML', 'SVF_Stressed',
    'SGDSInactive', 'DISPID_SRGDictationSetState',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SPPs_NewEnum',
    'DISPID_SPCLangId', 'ISpStream', 'SPWT_DISPLAY',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVResume', 'DISPID_SPRText', 'SPINTERFERENCE',
    'ISpeechObjectTokenCategory', 'DISPID_SPAStartElementInResult',
    'DISPID_SVEStreamStart', 'DISPID_SRCEventInterests',
    'DISPID_SRCRetainedAudio', 'ISpeechObjectTokens',
    'SpMemoryStream', 'DISPID_SPIAudioSizeTime',
    'SpeechPropertyComplexResponseSpeed', 'IEnumString',
    'DISPID_SRGIsPronounceable', 'SPPS_LMA', 'SPEI_SR_RETAINEDAUDIO',
    '_ISpeechVoiceEvents', 'SAFTExtendedAudioFormat',
    'SpeechRecognizerState', 'SAFT22kHz16BitStereo',
    'DISPID_SRGCmdLoadFromMemory', 'SREHypothesis',
    'SPEI_INTERFERENCE', 'SpeechUserTraining',
    'SpeechVoiceSkipTypeSentence', 'SpeechAllElements',
    'DISPID_SpeechRecoResultTimes',
    'SpeechPropertyHighConfidenceThreshold', 'SREBookmark',
    'eLEXTYPE_LETTERTOSOUND', 'SPAUDIOSTATE', 'SRTSMLTimeout',
    'SVEVoiceChange', 'SVEEndInputStream', 'DISPID_SRRTLength',
    'STCLocalServer', 'SRTReSent', 'SVP_8', 'ISpShortcut',
    'SpeechRegistryLocalMachineRoot', 'SPWORDLIST',
    'DISPID_SRGetRecognizers', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechFileStream', 'SAFTADPCM_11kHzMono',
    'SREPropertyNumChange', 'DISPID_SRDisplayUI',
    'DISPID_SRCEFalseRecognition', 'ISpeechRecoGrammar',
    'SpObjectTokenCategory', 'ISpPhoneticAlphabetSelection',
    'DISPID_SpeechPhraseReplacement',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPRsItem',
    'SPSTREAMFORMATTYPE', 'SPPHRASERULE', 'DISPID_SGRsAdd',
    'SREStreamEnd', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRSTText',
    'SPWAVEFORMATTYPE', 'SRSActive', 'SpeechEmulationCompareFlags',
    'DISPID_SVGetVoices', 'SP_VISEME_11', 'SVSFParseMask',
    'SPEI_MIN_TTS', 'SPVPRIORITY',
    'SpeechGrammarRuleStateTransitionType', 'SAFT24kHz8BitMono',
    'SRSEDone', 'DISPID_SVAudioOutput', 'ISpeechRecoContext',
    'DISPID_SDKCreateKey', 'DISPID_SWFEExtraData', 'DISPID_SRState',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGCmdLoadFromFile',
    'ISpeechPhraseRules', 'DISPID_SGRsCount', 'IEnumSpObjectTokens',
    'SPVOICESTATUS', 'DISPID_SpeechLexiconWords', 'SPEI_HYPOTHESIS',
    'SASPause', 'ISpObjectTokenCategory', 'SVEPrivate', 'SITooSlow',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_ALaw_8kHzMono',
    'SRTAutopause', 'ISpeechPhraseElements', 'SVP_10',
    'SPSHT_Unknown', 'eLEXTYPE_PRIVATE9', 'DISPID_SRGState',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SLWs_NewEnum',
    'SDKLCurrentUser', 'SpeechCategoryAudioOut',
    'DISPID_SADefaultFormat', 'DISPID_SGRsItem', 'SSFMCreateForWrite',
    'DISPID_SRRAlternates', 'SPVISEMES', 'SPEI_RESERVED6',
    'SpeechRecoEvents', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechPhraseAlternate', 'SAFT11kHz16BitStereo',
    'SVESentenceBoundary', 'SAFT12kHz8BitStereo', 'DISPID_SBSWrite',
    'DISPID_SGRSTPropertyId', 'DISPID_SOTRemove', 'SPCS_DISABLED',
    'ISpPhrase', 'SVPNormal', 'DISPID_SAEventHandle', 'SINoise',
    'SVPOver', 'IInternetSecurityMgrSite', 'SREAudioLevel',
    'SP_VISEME_5', 'DISPID_SpeechRecoContext', 'SAFT32kHz16BitStereo',
    'SpeechSpecialTransitionType', 'DISPID_SPAsItem',
    'eLEXTYPE_PRIVATE8', 'SAFT12kHz16BitMono', 'ISpResourceManager',
    'SpStreamFormatConverter', 'SREStateChange', 'SPCT_COMMAND',
    'SAFT11kHz16BitMono', 'DISPID_SPAPhraseInfo',
    'ISpStreamFormatConverter', 'DISPID_SPPEngineConfidence',
    'DISPID_SCSBaseStream', 'eLEXTYPE_USER', 'SVP_17',
    'DISPID_SPRFirstElement', 'SpMMAudioIn', 'DISPID_SPRulesItem',
    'ISpeechRecognizer', 'eLEXTYPE_RESERVED4',
    'DISPID_SPRuleChildren', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVPause', 'SPEI_START_SR_STREAM', 'IStream',
    'SDTReplacement', 'DISPID_SRCEPhraseStart',
    'SWPKnownWordPronounceable', 'DISPID_SVSLastBookmark', 'SVP_14',
    'DISPID_SVRate', 'SpAudioFormat', 'SPBO_NONE',
    'SpeechTokenContext', 'SRERecognition',
    'SpeechRetainedAudioOptions', 'SVEAudioLevel',
    'DISPID_SDKGetBinaryValue', 'SpResourceManager',
    'SpInprocRecognizer', 'Speech_Max_Pron_Length',
    'SAFT16kHz8BitMono', 'SPEI_TTS_BOOKMARK', 'SVSFNLPMask',
    'SPRST_ACTIVE', 'ISpMMSysAudio', 'SVSFVoiceMask',
    'SpeechDataKeyLocation', 'SpeechCategoryAudioIn', 'ISpProperties',
    'SPSSuppressWord', 'DISPID_SMSALineId', 'SVP_19',
    'DISPID_SPEPronunciation', 'SPEI_UNDEFINED', 'SBOPause',
    'LONG_PTR', 'DISPID_SRCSetAdaptationData', 'SPEI_VOICE_CHANGE',
    'DISPID_SLGetWords', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SGRSRule', 'SPCT_SUB_COMMAND', 'DISPID_SPPParent',
    'SpeechTokenShellFolder', 'SpeechTokenValueCLSID',
    'SpeechVoicePriority', 'WAVEFORMATEX', 'ISpeechPhraseInfoBuilder',
    'DISPID_SGRAddResource', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SLPLangId', 'DISPID_SVWaitUntilDone',
    'SpeechEngineProperties', 'SPEI_FALSE_RECOGNITION', 'SP_VISEME_8',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechRuleState',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPIElements',
    'SPEI_RESERVED3', 'DISPID_SGRSTPropertyName', 'SpeechDiscardType',
    'SpeechRuleAttributes', 'SPPHRASEPROPERTY', 'eLEXTYPE_PRIVATE3',
    'DISPID_SAStatus', 'DISPID_SRCEInterference', 'SVF_None',
    'DISPID_SPIAudioStreamPosition', 'eLEXTYPE_PRIVATE15',
    'SpCustomStream', 'DISPID_SASetState', 'ISpeechDataKey',
    'ISpNotifyTranslator', 'DISPID_SABIMinNotification',
    'DISPID_SABIBufferSize', 'DISPID_SRAudioInputStream',
    'eLEXTYPE_PRIVATE14', 'SpMMAudioOut', 'SPCS_ENABLED',
    'ISpeechPhraseAlternate', 'SGRSTTWildcard',
    'SpeechTokenKeyAttributes', 'DISPID_SRGCmdLoadFromObject',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpPhraseInfoBuilder',
    'SPVPRI_NORMAL', 'SWPUnknownWordPronounceable',
    'DISPID_SPRuleName', 'SAFTADPCM_8kHzStereo', 'SINone',
    'eLEXTYPE_PRIVATE13', 'SpeechRegistryUserRoot', 'tagSTATSTG',
    '_SPAUDIOSTATE', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseRule', 'SGSExclusive', 'SPGRAMMARSTATE',
    'DISPID_SVSVisemeId', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPAsCount', 'DISPID_SGRSAddWordTransition',
    'DISPID_SGRSTNextState', 'DISPID_SpeechLexicon',
    'SpeechGrammarTagUnlimitedDictation', 'SP_VISEME_6',
    'SAFTDefault', 'SPGS_ENABLED', 'DISPID_SDKEnumKeys',
    'SPEI_START_INPUT_STREAM', 'SPSEMANTICFORMAT',
    'eLEXTYPE_PRIVATE17', 'SRAInterpreter', 'eLEXTYPE_PRIVATE7',
    'SREPhraseStart', 'SVP_2', 'SPBO_AHEAD', 'DISPID_SVEBookmark',
    'SVEStartInputStream', 'DISPID_SOTCategory', 'SECFEmulateResult',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPIGrammarId',
    'DISPID_SPEsCount', 'SPCT_DICTATION', 'ISpeechRecoResult',
    'SFTSREngine', 'SpeechEngineConfidence', 'SPSUnknown', 'SVP_12',
    'SPEI_PHONEME', 'STSF_AppData',
    'DISPID_SVSLastStreamNumberQueued', 'SSSPTRelativeToStart',
    'SPWORDTYPE', 'SpeechTokenKeyUI', 'DISPID_SVGetProfiles',
    'DISPID_SRGRecoContext', 'DISPID_SpeechPhraseInfo',
    'ISpeechGrammarRules', 'SDTDisplayText', 'DISPID_SLPPartOfSpeech',
    'SGRSTTWord', 'DISPID_SGRsDynamic', 'SP_VISEME_13',
    'DISPID_SVESentenceBoundary', 'SVP_20', 'SpeechLoadOption',
    'SDA_Two_Trailing_Spaces', 'DISPID_SOTsItem',
    'SpeechAddRemoveWord', 'DISPID_SVEAudioLevel', 'SPWF_INPUT',
    'SGSDisabled', 'SPEVENTSOURCEINFO', 'SPEI_WORD_BOUNDARY',
    'SP_VISEME_9', 'DISPID_SPCPhoneToId', 'ISpeechRecoResult2',
    'DISPID_SAFType', 'SP_VISEME_7', 'DISPID_SPAs_NewEnum',
    'SPRS_INACTIVE', 'SPFILEMODE', 'SPEI_PHRASE_START',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SOTCSetId',
    'DISPID_SPRuleConfidence', 'SpeechTokenKeyFiles', 'ISpeechAudio',
    'SPRST_INACTIVE', 'SVP_6', 'SVPAlert',
    'DISPID_SVSInputWordLength', 'SAFTCCITT_ALaw_22kHzMono',
    'STCInprocServer', 'SVP_9', 'SGDSActive', 'ISpXMLRecoResult',
    'SPEI_SOUND_END', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPERetainedStreamOffset', 'SPSModifier', 'SSTTWildcard',
    'SPFM_OPEN_READONLY', 'SPLEXICONTYPE', 'SGDisplay',
    'SREInterference', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SOTSetId', 'SAFT8kHz16BitStereo', 'DISPID_SPEs_NewEnum',
    'DISPID_SDKGetStringValue', 'DISPID_SGRAddState',
    'SPDKL_LocalMachine', 'SVP_13', 'SLOStatic',
    'SPWORDPRONOUNCEABLE', 'SPSNoun', 'SAFTGSM610_44kHzMono',
    'SAFT24kHz8BitStereo', 'DISPID_SRCState',
    'ISpeechTextSelectionInformation', 'DISPID_SPIProperties',
    'SpTextSelectionInformation', 'SPEI_MAX_TTS', 'SPFM_NUM_MODES',
    'ISpObjectWithToken', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPGS_DISABLED', 'DISPID_SGRsCommitAndSave', 'SPAS_CLOSED',
    'ISpRecognizer', 'SPPROPERTYINFO', 'SINoSignal',
    'DISPID_SOTGetStorageFileName', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechRecoResult', 'DISPID_SVGetAudioOutputs',
    'SpeechTokenIdUserLexicon', 'SPCONTEXTSTATE',
    'DISPID_SRCCreateGrammar', 'SAFT32kHz16BitMono',
    'SAFT22kHz8BitStereo', 'SPDKL_CurrentConfig',
    'eLEXTYPE_VENDORLEXICON', 'SAFT16kHz16BitMono',
    'SAFT11kHz8BitMono', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRCResume', 'SPEI_SOUND_START', 'SPFM_CREATE_ALWAYS',
    'SPPS_RESERVED3', 'SRAORetainAudio', 'DISPID_SRCEStartStream',
    'SPLO_STATIC', 'DISPID_SOTCEnumerateTokens',
    'SPINTERFERENCE_NOISE', 'DISPID_SRSCurrentStreamNumber',
    'ISpNotifySink', 'SAFT12kHz8BitMono', 'DISPIDSPTSI',
    'DISPID_SRGSetWordSequenceData', 'SAFT8kHz8BitStereo',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPRuleEngineConfidence',
    'DISPID_SPANumberOfElementsInResult', 'SPDATAKEYLOCATION',
    'SGRSTTRule', 'DISPIDSPRG', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SDKDeleteKey', 'DISPID_SPCIdToPhone',
    'DISPID_SOTRemoveStorageFileName', 'SPAR_Medium',
    'DISPID_SPRNumberOfElements', 'SRCS_Disabled',
    'tagSPPROPERTYINFO', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_VISEME', 'DISPID_SRRSaveToMemory',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpEventSink', 'SpLexicon',
    'SSFMOpenForRead', 'DISPID_SWFEFormatTag', 'DISPID_SPEsItem',
    'ISpeechVoice', 'SpeechCategoryRecognizers',
    'DISPID_SRSClsidEngine', 'DISPID_SpeechObjectTokens',
    'SPINTERFERENCE_TOOSLOW', 'SRTExtendableParse',
    'DISPID_SRRTTickCount', 'ISpPhraseAlt', 'SDTAudio',
    'DISPID_SABufferInfo', 'DISPID_SLWsCount', 'SSTTDictation',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SVSpeakStream',
    'SpNotifyTranslator', 'SRTStandard', 'SpeechLexiconType',
    '__MIDL_IWinTypes_0009', 'DISPID_SPIReplacements',
    'DISPID_SPIStartTime', 'SVP_11', 'SAFTNoAssignedFormat',
    'SP_VISEME_4', 'DISPID_SPIEngineId', 'DISPID_SGRName',
    'SPEI_END_INPUT_STREAM', 'SAFTCCITT_uLaw_22kHzMono',
    ...
    'DISPID_SLRemovePronunciation', 'SPPS_Noun', 'SpObjectToken',
    'STSF_LocalAppData', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFTCCITT_uLaw_11kHzMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCESoundEnd', 'SDTRule',
    'DISPID_SMSAMMHandle', 'DISPID_SRCEAdaptation',
    'DISPID_SRSetPropertyString', 'SpeechCategoryRecoProfiles',
    'SAFT16kHz8BitStereo', 'ISpRecoGrammar2', 'DISPID_SPPsCount',
    'SPRECOGNIZERSTATUS', 'SAFTCCITT_uLaw_44kHzMono',
    'SPRST_ACTIVE_ALWAYS', 'SPEI_REQUEST_UI',
    'DISPID_SVEventInterests', 'DISPID_SRCEBookmark',
    'DISPID_SGRSTWeight', 'SPDKL_DefaultLocation', 'SVEPhoneme',
    'SPEI_TTS_PRIVATE', 'ISpeechPhraseRule', 'DISPID_SRRAudioFormat',
    'DISPID_SLPType', 'SAFTGSM610_22kHzMono',
    'DISPID_SDKSetStringValue', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE10', 'SVSFDefault',
    'DISPID_SOTGetDescription', 'SVF_Emphasis', 'SPSHORTCUTTYPE',
    'SRADynamic', 'DISPID_SpeechDataKey', 'SASStop',
    'DISPID_SRCPause', 'SpMMAudioEnum', 'SAFT8kHz16BitMono',
    'SPEI_MIN_SR', 'SVEAllEvents', 'SpeechWordType',
    'SPEI_SR_AUDIO_LEVEL', 'SAFTCCITT_uLaw_22kHzStereo',
    'SREFalseRecognition', 'DISPID_SVPriority', 'DISPID_SLPPhoneIds',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRRecognizer',
    'DISPID_SLPsCount', 'SSSPTRelativeToEnd', 'ISpRecoContext2',
    'SPSHORTCUTPAIR', 'DISPIDSPTSI_ActiveOffset',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechPhraseAlternates', 'SPRULE',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechRecoProfileProperties', 'eLEXTYPE_APP',
    'eLEXTYPE_PRIVATE11', 'SBONone', 'ISpeechRecoResultDispatch',
    'SECFDefault', 'SpeechPropertyResourceUsage',
    'SAFTGSM610_11kHzMono', 'SPPS_Noncontent', 'SpCompressedLexicon',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRGDictationLoad',
    'SPFM_OPEN_READWRITE', 'SP_VISEME_17', 'ISpGrammarBuilder',
    'DISPID_SOTsCount', 'SpeechFormatType', 'SPAUDIOOPTIONS',
    'DISPID_SLWLangId', 'DISPID_SFSClose', 'DISPID_SLPSymbolic',
    'SPINTERFERENCE_NOSIGNAL', 'SpPhoneticAlphabetConverter',
    'SAFT48kHz8BitStereo', 'ISpeechGrammarRule', 'DISPID_SRIsShared',
    'ISpRecoContext', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPLOADOPTIONS', 'DISPID_SDKDeleteValue',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_RESERVED5', 'SDTPronunciation',
    'DISPID_SRCERecognitionForOtherContext',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpObjectToken',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRs_NewEnum', 'DISPID_SPRuleFirstElement',
    'SpeechDisplayAttributes', 'SVP_7'
]

_check_version('1.2.0', 1698429281.434428)
