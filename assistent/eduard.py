...
greetings_bot = print("Seja Bem-Vindo!\nSou Eduard! Seu assistente virtual.") # Virtual Assistant starting a conversation
first_keyword = ["pesquisa", "calcular", "abrir", "documento", "cotaçao", "tradutor"] # list of items that will be used during the conversation

# debug loop in case the user has more questions
while True:

    greetings_user = input("Como posso te ajudar?\nR: ") # input for the user to enter what they want to insert
    if greetings_user in first_keyword: # checking what the user type contains in the list above
        ...
        if greetings_user == 'tradutor':
            print("Antes de escolher a língua desejada, escreva corretamente para o álgoritimo identificar")
