...
while True:
    ...
    if greetings_user.lower() in base["calendario"]:
        sleep(1)
        os.system("cls")
        for i in rp.calendary():
            print(i)

    elif greetings_user.lower() in base["clima"]:
        sleep(1)
        os.system("cls")
        print(rp.climate_of_the_region())

    if greetings_user.lower() in base["calcular"]:
        sleep(1)
        os.system("cls")
        rp.calculator()

    if greetings_user.lower() in base["open"]:
        sleep(1)
        os.system("cls")
    ...
    if greetings_user.lower() in base["dock"]:
        sleep(1)
        os.system("cls")
        print(
    ...
    if greetings_user.lower() in base["cotacao"]:
        sleep(1)
        os.system("cls")
    ...
    if greetings_user.lower() in base["tradutor"]:
        sleep(1)
        os.system("cls")
        print(
    ...
    if greetings_user.lower() in base["esta"]:
        sleep(1)
        os.system("cls")
        print("Eu estou bem!")
    if greetings_user.lower() in base["sair"]:
        sleep(1)
